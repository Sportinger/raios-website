...
| 00:52.000–00:59.602 | `feedback-fix.mp3` | 7.602 s | The failure returns a precise report. The agent fixes the source and compiles again. |
| 00:59.602–01:18.018 | `shadow-rehearsal-fail.mp3` | 18.416 s | A disposable Shadow VM opens. A ghost copy receives only mocked input and files. The replay reaches only 653 of 654 claims. The frame hash mismatches. The test fails closed. |
| 01:18.018–01:27.396 | `twin-build-fix.mp3` | 9.378 s | The mismatch returns as a precise report. After the fix, two independent builds produce exactly the same bytes. |
