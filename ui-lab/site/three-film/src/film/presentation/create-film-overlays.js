...
.film-original-voice{position:absolute;top:clamp(20px,4vh,44px);left:50%;width:max-content;max-width:calc(100% - 80px);margin:0;color:#f5f7fa;text-align:center;white-space:nowrap;transform:translateX(-50%);font-size:60px;font-weight:800;line-height:1.05;letter-spacing:.005em;text-shadow:0 2px 18px rgba(0,0,0,.92),0 1px 5px rgba(0,0,0,.98);opacity:0;will-change:opacity}
