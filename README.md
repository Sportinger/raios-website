...
3. Der Button bleibt während seiner Einführung räumlich vollständig statisch. Eine unsichtbare neutralweiße Punktlichtquelle beginnt direkt hinter ihm und orbitiert auf einer horizontalen 240-Grad-Kreisbahn gegen den Uhrzeigersinn nach vorne. Während dieses Reveals sind globales Hemisphere-/Key-Light und das frühere blaue Button-Point-Light deaktiviert; das orbitierende Point Light ist die einzige reale Lichtquelle und erzeugt über eine `BasicShadowMap` bewusst harte wandernde Schatten. Noch während dieses Reveals umkreist der Camera-Rig den Button um 90 Grad nach rechts. Exakt beim vollständig gedrückten Zustand starten ON-Impuls und Kamera-Follow gemeinsam. Der Impulskern bleibt als exaktes Kameraziel im Bildzentrum, während der Follow zunächst kräftig beschleunigt, anschließend ruhiger wird, kontinuierlich an Höhe und Abstand gewinnt und auf die ursprüngliche Kameraseite zurückorbitiert. Das globale Licht fährt erst später für Bare Metal und Kernel hoch.
