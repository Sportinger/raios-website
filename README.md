...
2. Ein von Anfang an vollständig sichtbares, grau-metallisches Kabel beginnt mittig an der Rückseite des Buttons, läuft zunächst gerade aus dem Gehäuse, sinkt auf eine unsichtbare Bodenhöhe ab und schlängelt sich erst dort bis an die Seitenkante des weit entfernten `BARE METAL`-Layers. Eine kompakte organische Plasmawolke startet synchron mit dem Beginn des Button-Presses und seines blauen Power-Glows. Ihr optisch dichter weiß-blauer Kern ist ein entlang der Kabelrichtung gestrecktes, opakes und tiefenschreibendes Volumen im regulären Render-Pass. Dadurch verdeckt er das Kabel aus jedem Kamerawinkel vollständig, ohne als Ring mit durchsichtigem Zentrum zu erscheinen. Alle äußeren Plasma-Layer verwenden weiterhin den regulären Depth-Test: Am rückseitigen Kabelanschluss verdeckt das Button-Gehäuse die Wolke vollständig, bis sie seitlich hinter seinem Rand hervortritt. Nach außen löst sie sich über mehrere unregelmäßige prozedurale Glow-Schichten, rotierende Plasmafilamente und einen kurzen Nachschweif weich auf; geometrische Schockringe werden nicht gezeichnet. Ein zurückhaltendes mitwanderndes Punktlicht beleuchtet nur ihre unmittelbare Umgebung. Die einzige Kabeloberfläche wechselt direkt dahinter von Grau zu elektrisch leuchtendem Blau; es werden keine übereinanderliegenden Kabelröhren mehr gezeichnet. Schmale blaue Energieringe fließen anschließend in Impulsrichtung über den bereits aktivierten Abschnitt. Button und Layer liegen auf derselben Welt-Höhe; der Layer ist von Anfang an räumlich vorhanden und wird nicht eingeblendet.
