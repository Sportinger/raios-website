...
3. Noch während der Button einfährt, umkreist ihn der Camera-Rig um 90 Grad nach rechts. Exakt beim vollständig gedrückten Zustand starten ON-Impuls und Kamera-Follow gemeinsam. Der Follow beschleunigt zunächst kräftig, wird anschließend ruhiger, gewinnt kontinuierlich an Höhe und Abstand und orbitiert während des Vorwärtsflugs auf die ursprüngliche Kameraseite zurück; der Button verlässt dabei natürlich den Bildausschnitt.
