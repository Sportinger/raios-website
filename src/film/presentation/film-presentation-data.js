...
export const FILM_STATUS_WINDOWS = freezeEntries([
  ...
  { start: 71.2, end: 82, tone: "active", text: "TEST 1 · CLAIMS · LILAC" },
  { start: 83, end: 89.5, tone: "active", text: "TEST 2 · PARALLEL DIVERGENCE · AMBER" },
  { start: 90.5, end: 98.2, tone: "error", text: "TEST 3 · FAIL-CLOSED · ICE" },
  { start: 98.2, end: 99, tone: "success", text: "3 / 3 TESTS PASSED" },
  { start: 99, end: 103.55, tone: "active", text: "GUARD · VERIFYING BINDINGS" },
  { start: 103.55, end: 107, tone: "success", text: "OWNER APPROVED" },
  { start: 107, end: 115, tone: "success", text: "LIVE DOOR OPEN" },
  { start: 115, end: 125, tone: "active", text: "PLAYER RUNNING" },
  { start: 125, end: 131, tone: "active", text: "PRIVATE APP ISLAND" },
  { start: 131, end: 139, tone: "success", text: "21 ISOLATED APP ISLANDS" },
]);
